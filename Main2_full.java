...
/Users/tholenst/dev/jdk4/build/macosx-aarch64/jdk/bin/java -XX:-TieredCompilation -XX:CompileCommand=dontinline,Main::computeLog -XX:CompileCommand=compileonly,Main::compute -XX:CompileCommand=compileonly,Main::computeFdLibm  -XX:CompileCommand=compileonly,Main::computeLog -XX:CompileCommand=dontinline,java.lang.Double::* -XX:+UnlockDiagnosticVMOptions -XX:+PrintCompilation -XX:+PrintInlining -XX:CompileCommand=quiet -XX:+UnlockDiagnosticVMOptions -XX:CompileCommand=print,*::compute Main2_full.java
